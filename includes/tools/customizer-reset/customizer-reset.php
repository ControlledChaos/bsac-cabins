...
namespace BSAC_Cabins\Includes\Tools\Customizer_Reset;
...
final class Customizer_Reset {
	...
	public function customize_controls_print_scripts() {
		...
		wp_enqueue_script( 'bsacc-customizer-reset', BSACC_URL . 'includes/tools/customizer-reset/assets/js/customizer-reset.js', [ 'jquery' ], '20150120' );

		wp_localize_script( 'bsacc-customizer-reset', '_BSACCCustomizerReset', [
			'reset'   => __( 'Reset', 'bsac-cabins' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'bsac-cabins' ),
			'nonce'   => [
 ...
 */
function bsacc_customizer_reset() {
