...
( function() {
	...
	*/
	registerBlockType( 'bsacc/sample-block', {
		...
		edit: function(props) {
			// Creates a <p class='wp-block-bsacc-sample-block"'></p>.
			return el(
				'p', // Tag type.
				{ className: props.className }, // The class="wp-block-bsacc-sample-block" : The class name is generated using the block's name prefixed with wp-block-, replacing the / namespace separator with a single -.
