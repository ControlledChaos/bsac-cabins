...
class Media {
	...
	private function dependencies() {
		...
		include_once BSACC_PATH . 'includes/media/class-svg-support.php';

		// Replace WP gallery shortcode if Fancybox option is used.
		$fancybox = get_option( 'bsacc_enqueue_fancybox_script' );

		if ( $fancybox ) {
			require_once BSACC_PATH . 'includes/media/class-gallery-shortcode.php';
		}
	...
	public function image_sizes() {
		 ...
		 */
		add_image_size( __( 'Column Thumbnail', 'bsac-cabins' ), 48, 48, true );
	...
	public function rss_featured_images( $content ) {
		...
		$size = apply_filters( 'bsacc_rss_featured_image_size', 'medium' );
