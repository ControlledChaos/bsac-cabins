...
class Extend_ACF {
	...
	public function admin_styles() {
		...
		wp_enqueue_style( BSACC_ADMIN_SLUG . '-acf-admin', BSACC_URL . 'includes/acf/assets/css/admin.min.css', [], BSACC_VERSION, 'screen' );
	...
	public function admin_scripts() {
		...
		wp_enqueue_script( BSACC_ADMIN_SLUG . '-acf-admin', BSACC_URL . 'includes/acf/assets/js/admin.min.js', [ 'jquery' ], BSACC_VERSION, true );
