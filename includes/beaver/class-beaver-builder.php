...
class BSACC_Beaver_Builder {
	...
	static public function load_modules() {
		...
		require_once BSACC_PATH . 'includes/beaver/modules/basic-example/basic-example.php';
		require_once BSACC_PATH . 'includes/beaver/modules/example/example.php';
	...
	static public function register_fields( $fields ) {
		...
		$fields['bsacc-custom-beaver-field'] = BSACC_PATH . 'includes/beaver/fields/custom-fields.php';
		return $fields;
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'bsacc-beaver-fields', BSACC_URL . 'includes/beaver/assets/css/fields.css', [], '' );
		wp_enqueue_script( 'bsacc-beaver-fields', BSACC_URL . 'includes/beaver/assets/js/fields.js', [], '', true );
...
// Run the class.
$bsacc_beaver_builder = new BSACC_Beaver_Builder;