...
class Post_Types_Taxes {
	...
	public function dependencies() {
		...
		require_once BSACC_PATH . 'includes/post-types-taxes/class-register-post-types.php';

		// Resister cutsom taxonomies.
		require_once BSACC_PATH . 'includes/post-types-taxes/class-register-taxonomies.php';
