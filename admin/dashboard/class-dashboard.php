...
class Dashboard {
	...
	private function dependencies() {
        ...
        require BSACC_PATH . 'admin/dashboard/class-dashboard-widget.php';

        // Get the welcome panel class.
        require BSACC_PATH . 'admin/dashboard/class-welcome.php';
    ...
    public function metaboxes() {
        ...
        if ( bsacc_acf_options() ) {
            ...
            $hide = get_field( 'bsacc_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'bsacc_hide_welcome' );
            $gutenberg  = get_option( 'bsacc_hide_try_gutenberg' );
            $editor     = get_option( 'bsacc_classic_editor' );
            $wp_news    = get_option( 'bsacc_hide_wp_news' );
            $quickpress = get_option( 'bsacc_hide_quickpress' );
            $at_glance  = get_option( 'bsacc_hide_at_glance' );
            $activity   = get_option( 'bsacc_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Welcome Panel', 'bsac-cabins' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'bsac-cabins' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once BSACC_PATH . 'admin/dashboard/partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once BSACC_PATH . 'admin/dashboard/partials/help/help-dashboard-widgets.php';
    ...
    public function help_dashboard_sidebar() {
        ...
        $html  = sprintf(
            '<h4>%1s %2s</h4>',
            __( 'Custom Dashboard for', 'bsac-cabins' ),
             get_bloginfo( 'name' )
        );
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( BSACC_ADMIN_SLUG . '-dashboard', BSACC_URL .  'admin/dashboard/assets/css/dashboard.min.css', [], null, 'screen' );
        }
