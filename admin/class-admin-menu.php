...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( bsacc_acf_options() ) {
            ...
            $options = get_field( 'bsacc_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( bsacc_acf_options() ) {
            $links = get_field( 'bsacc_links_manager', 'option' );
        } else {
            $links = get_option( 'bsacc_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( bsacc_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'bsacc_hide_appearance' );
            $plugins    = get_option( 'bsacc_hide_plugins' );
            $users      = get_option( 'bsacc_hide_users' );
            $tools      = get_option( 'bsacc_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( bsacc_acf_options() ) {
            ...
            $menus_link   = get_field( 'bsacc_menus_position', 'option' );
            $widgets_link = get_field( 'bsacc_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'bsacc_menus_position' );
            $widgets_link = get_option( 'bsacc_widgets_position' );
