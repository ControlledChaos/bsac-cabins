...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'bsacc_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( bsacc_acf_options() ) {
			...
			$blog_image    = get_field( 'bsacc_meta_blog_image', 'option' );
			$default_image = get_field( 'bsacc_meta_default_image', 'option' );
